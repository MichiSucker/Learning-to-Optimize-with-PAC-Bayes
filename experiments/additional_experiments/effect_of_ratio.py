...
def plot_results(loading_path):
    ...
    plt.tight_layout()
    fig.savefig(loading_path + 'comparison_ratio_of_losses.pdf', dpi=300, bbox_inches='tight', pad_inches=0)
    fig.savefig(loading_path + 'comparison_ratio_of_losses.png', dpi=300, bbox_inches='tight', pad_inches=0)
