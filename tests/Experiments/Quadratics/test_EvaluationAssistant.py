...
from experiments.quadratics.evaluation import EvaluationAssistant
...
class TestEvaluationAssistant(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.eval_assist = EvaluationAssistant(
            test_set=self.test_set, number_of_iterations_for_training=self.number_of_iterations_during_training,
            loss_of_algorithm=dummy_loss, initial_state=self.initial_state,
